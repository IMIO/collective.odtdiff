...
import collective.odtdiff


class CollectiveOdtdiffLayer(PloneSandboxLayer):

    defaultBases = (PLONE_FIXTURE,)
    products = ('collective.odtdiff',
               )
    ...
    def setUpPloneSite(self, portal):
        ...
        applyProfile(portal, 'collective.odtdiff:testing')
...
FIXTURE = CollectiveOdtdiffLayer(
    name="FIXTURE"
    )
